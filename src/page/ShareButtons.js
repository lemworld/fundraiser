...
class ShareButtons extends React.Component {
    ...
    getShareText() {
        return encodeURIComponent(this.props.sharetext);
    }
        ...
        return (
            <div className="shareButtonsContainter">
                ...
                <div className="shareButtons">
                    <a className="resp-sharing-button__link" href={"https://facebook.com/sharer/sharer.php?u=" + this.getShareTargetURL()} target="_blank" aria-label="">
                    ...
                    <a className="resp-sharing-button__link" href={"https://twitter.com/intent/tweet/?text=" + this.getShareText() + "&url=" + this.getShareTargetURL()} target="_blank" aria-label="">
                    ...
                    <a className="resp-sharing-button__link" href={"mailto:?subject=" + this.getShareText() + "&body=" + this.getShareTargetURL()} target="_blank" aria-label="">
